...
> **Editor's note, 11 September 2026.** This piece was written before the Hong Kong investor group behind the 2020 purchase became the subject of an American indictment, US, UK and EU sanctions, an extradition to China and a series of court actions that have now interrupted Habanos distribution in several European markets. It remains accurate on the mechanics of the 2020 sale and on the strategy that followed, but it is no longer the whole story. For the ownership chain, the criminal case and what it has done to supply, see [The Man Who Owned a Quarter of Habanos](/blog/habanos-chen-zhi-ownership-sanctions-explained/).
