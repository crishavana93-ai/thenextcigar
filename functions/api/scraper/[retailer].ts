...
const SCRAPERS: Record<string, ScraperConfig> = {
  ...
  "ch-egmcigars": {
    ...
    pdps: [
      ...
      { url: "https://egmcigars.com/products/cohiba-siglo-6-slb.json", skuHint: "cohiba-siglo-vi" },
      { url: "https://egmcigars.com/products/montecristo-edmundo.json", skuHint: "montecristo-edmundo" },
      { url: "https://egmcigars.com/products/romeo-y-julieta-wide-churchill.json", skuHint: "romeo-y-julieta-wide-churchills" },
      { url: "https://egmcigars.com/products/partagas-lusitanias.json", skuHint: "partagas-lusitanias" },
      { url: "https://egmcigars.com/products/h-upmann-magnum-46-slb.json", skuHint: "h-upmann-magnum-46" },
      { url: "https://egmcigars.com/products/cohiba-siglo-2-slb.json", skuHint: "cohiba-siglo-ii" },
      { url: "https://egmcigars.com/products/romeo-y-julieta-short-churchill.json", skuHint: "romeo-y-julieta-short-churchills" },
      { url: "https://egmcigars.com/products/bolivar-royal-coronas-a-t.json", skuHint: "bolivar-royal-coronas" },
      { url: "https://egmcigars.com/products/hoyo-de-monterrey-epicure-especial-slb.json", skuHint: "hoyo-de-monterrey-epicure-especial" },
      ...
      { url: "https://egmcigars.com/products/cohiba-medio-siglo-slb.json", skuHint: "cohiba-medio-siglo" },
      { url: "https://egmcigars.com/products/partagas-serie-e-no-2.json", skuHint: "partagas-serie-e-no-2" },
      { url: "https://egmcigars.com/products/hoyo-de-monterrey-le-hoyo-de-rio-seco-cigar-box-of-25.json", skuHint: "hoyo-de-monterrey-le-hoyo-de-rio-seco" },
      { url: "https://egmcigars.com/products/h-upmann-magnum-50-slb.json", skuHint: "h-upmann-magnum-50" },
      { url: "https://egmcigars.com/products/romeo-y-julieta-churchill.json", skuHint: "romeo-y-julieta-churchill" },
      { url: "https://egmcigars.com/products/cohiba-maduro-magicos-5-bn.json", skuHint: "cohiba-maduro-5-magicos" },
      ...
      { url: "https://egmcigars.com/products/cohiba-siglo-3-slb.json", skuHint: "cohiba-siglo-iii" },
      { url: "https://egmcigars.com/products/romeo-y-julieta-no-1.json", skuHint: "romeo-y-julieta-no-1-tubos" },
      { url: "https://egmcigars.com/products/h-upmann-connoisseur-no-1.json", skuHint: "h-upmann-connoisseur-no-1" },
      { url: "https://egmcigars.com/products/juan-lopez-seleccion-no-1-slb.json", skuHint: "juan-lopez-seleccion-no-1" },
      { url: "https://egmcigars.com/products/vegas-robaina-famosos.json", skuHint: "vegas-robaina-famosos" },
      { url: "https://egmcigars.com/products/quai-dorsay-no-50-box-of-10-cigars.json", skuHint: "quai-d-orsay-no-50" },
      { url: "https://egmcigars.com/products/ramon-allones-specially-selected.json", skuHint: "ramon-allones-specially-selected" },
      { url: "https://egmcigars.com/products/romeo-y-julieta-saint-luis-regios.json", skuHint: "saint-luis-rey-regios" },
      { url: "https://egmcigars.com/products/rey-del-mundo-choix-supreme.json", skuHint: "el-rey-del-mundo-choix-supreme" },
      { url: "https://egmcigars.com/products/por-larranaga-petit-coronas.json", skuHint: "por-larranaga-petit-coronas" },
      { url: "https://egmcigars.com/products/la-gloria-cubana.json", skuHint: "la-gloria-cubana-medaille-d-or-no-4" },
      { url: "https://egmcigars.com/products/diplomaticos-no-2.json", skuHint: "diplomaticos-no-2" },
      { url: "https://egmcigars.com/products/san-cristobal-de-la-habana-la-punta.json", skuHint: "san-cristobal-la-punta" },
